...
using System;
using System.Text;
using State = SadConsole.Ansi.State;
using Document = SadConsole.Ansi.Document;

namespace SadConsole.Private.Ansi {
    /// <summary>
                            ...
                            for (int i = 0; i < count; i++) {
                                ...
                                switch (value) {
                                    ...
                                    case 7:
                                        ...
                                        _ansiState.Foreground = SadConsole.Ansi.Helpers.AnsiAdjustColor(_ansiState.Background, _ansiState.Bold);
                                        _ansiState.Background = SadConsole.Ansi.Helpers.AnsiJustNormalColor(tempFore);
                                        break;
                                    case 30:
                                    case 31:
                                    case 32:
                                    ...
                                    case 36:
                                    case 37:
                                        SadConsole.Ansi.Helpers.AnsiConfigurePrintColor(false, value - 30, _ansiState);
                                        break;
                                    case 40:
                                    case 41:
                                    case 42:
                                    ...
                                    case 46:
                                    case 47:
                                        SadConsole.Ansi.Helpers.AnsiConfigurePrintColor(true, value - 40, _ansiState);
                                        break;
                                }
                            }
                        }
